            ...
            <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="{{route('logar')}}" method="post">
                        @csrf
                        @if ($errors->any())
                        <div class="alert text-red-500 font-bold">
                            <ul>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="#" class="text-sm font-medium text-blue-600 hover:underline dark:text-blue-500">Esqueci a senha</a>
                        </div>
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Ainda não possui conta? <a href="{{route('telaCadastro')}}" class="font-medium text-blue-600 hover:underline dark:text-blue-500">Cadastre-se</a>
                        </p>
                    </form>
                </div>
            </div>
